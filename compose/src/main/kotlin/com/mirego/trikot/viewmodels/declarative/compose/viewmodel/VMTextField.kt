...
fun VMTextField(
    ...
    val textFieldViewModel: TextFieldViewModel by viewModel.observeAsState()
    val keyboardActionsDelegate = buildKeyboardActions(viewModel, keyboardActions)

    TextField(
        modifier = modifier.hidden(textFieldViewModel.hidden),
...
fun buildKeyboardActions(viewModel: TextFieldViewModel, keyboardActions: KeyboardActions) =
    KeyboardActions(
        onDone = {
