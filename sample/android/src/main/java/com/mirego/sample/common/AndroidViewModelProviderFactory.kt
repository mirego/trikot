package com.mirego.sample.common

import androidx.fragment.app.Fragment
import androidx.fragment.app.FragmentActivity
import androidx.lifecycle.ViewModel
import androidx.lifecycle.ViewModelProvider
import com.mirego.sample.factories.Bootstrap
import com.mirego.sample.viewmodels.base.BaseViewModelController
...
class AndroidViewModelProviderFactory {
    ...
    class ParametrizedFactory(
        ...
        private fun getParametersErrorString(): String {
            ...
            val joinToString = constructorParams.joinToString(
                separator = ", "
