...
fun <E : VMDPickerItemViewModel> VMDDropDownMenu(
    ...
    val pickerViewModel by viewModel.observeAsState()
    if (pickerViewModel.isHidden) return

    DropdownMenu(expanded, onDismissRequest, modifier, offset, properties) {
...
fun <E : VMDPickerItemViewModel> VMDDropDownMenuItem(
    ...
    val pickerItemViewModel by viewModel.observeAsState()
    if (pickerItemViewModel.isHidden) return
